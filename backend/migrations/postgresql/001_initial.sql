...
CREATE TABLE IF NOT EXISTS source_metadata_revisions (
  ...
  snapshot_json JSONB NOT NULL, created_at TIMESTAMPTZ NOT NULL, UNIQUE(source_id, ordinal)
);
...
CREATE TABLE IF NOT EXISTS evidence (
  ...
  excerpt TEXT NOT NULL, excerpt_hash TEXT NOT NULL, is_validated BOOLEAN NOT NULL DEFAULT TRUE,
  created_at TIMESTAMPTZ NOT NULL
);
CREATE INDEX IF NOT EXISTS idx_evidence_version ON evidence(content_version_id);
CREATE TABLE IF NOT EXISTS citations (
  id TEXT PRIMARY KEY, evidence_id TEXT NOT NULL REFERENCES evidence(id), created_at TIMESTAMPTZ NOT NULL
);
...
CREATE TABLE IF NOT EXISTS external_cards (id TEXT PRIMARY KEY, card_type TEXT NOT NULL, url TEXT NOT NULL, title TEXT NOT NULL, author TEXT, notes TEXT, tags_json JSONB NOT NULL, created_at TIMESTAMPTZ NOT NULL, UNIQUE(card_type, url));
